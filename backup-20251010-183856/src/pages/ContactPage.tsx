      ...
      <section className="relative overflow-hidden py-20 lg:py-32" style={{
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl lg:text-2xl text-neutral-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-20">
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-xl border border-neutral-200 h-full">
