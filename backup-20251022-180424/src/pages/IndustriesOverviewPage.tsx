        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mt-8">
              ...
              <Link to="/industries/medical-practices" className="btn btn-secondary shadow-strong">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="card text-center group hover:shadow-xl transition-all duration-300 animate-fade-in-up">
              ...
              <Link to="/industries/aba-practices" className="btn btn-outline w-full">
                View ABA R&D
            ...
            <div className="card text-center group hover:shadow-xl transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-success-500 to-success-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
              ...
              <Link to="/industries/medical-practices" className="btn btn-outline w-full">
                View Medical R&D
                <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
            </div>
            ...
            <div className="card text-center group hover:shadow-xl transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-accent-500 to-accent-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="section">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <Link to="/contact" className="btn btn-success shadow-strong transform hover:scale-110">
