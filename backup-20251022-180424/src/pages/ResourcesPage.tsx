        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="text-center mt-8">
              <a href="#newsletter" className="btn btn-secondary shadow-strong">
            ...
            <div className="card group cursor-pointer hover:shadow-xl transition-all duration-300">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <Link to="/rd-tax-credit-guide" className="btn btn-primary shadow-strong">
                    Read Complete Guide
                    <ArrowRight className="w-5 h-5 ml-2" />
                  </Link>
                </div>
      ...
      <section className="section">
        <div className="container">
          <div className="card" style={{ textAlign: "center", maxWidth: "600px", margin: "0 auto" }}>
            ...
            <Link to="/contact" className="btn btn-success shadow-strong">
