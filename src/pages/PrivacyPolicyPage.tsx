...
export default function PrivacyPolicyPage() {
  const pageTitle = "Privacy Policy | ROI Blueprint";
  const pageDescription =
    "ROI Blueprint Privacy Policy. Learn how we collect, use, and protect your personal information when you use our healthcare R&D consulting services.";
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed">
                  ROI Blueprint ("we," "our," or "us") is committed to protecting
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed mt-4">
                  ...
                  number, business name, practice information, and other details
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed">
                  ...
                  means to protect your information, we cannot guarantee
                  absolute security.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-neutral-600 leading-relaxed">
                  For clients engaging our services, we maintain HIPAA-compliant
                  systems and processes to protect protected health information
                  (PHI). Our technology platform and documentation procedures
