...
export default function ServicesPage() {
  ...
  return (
    <div>
      ...
      <StructuredData
        type="webpage"
        pageTitle="R&D Tax Credit Services for Healthcare Practices"
        pageDescription="ROI Blueprint™ methodology: Research, Optimize, Innovate. Full-service R&D implementation for medical and ABA practices. Performance-based pricing with $50K-$250K average eligible activities identified."
        pageUrl="/services"
      />
      ...
      <section
        ...
        style={{
          ...
          url('/servicesherotiny.jpg') center/cover no-repeat
        `
        }}
      >
        <div className="container">
          <div className="hero-content">
            ...
            <p>
              ROI BLUEPRINT™ helps healthcare organizations document their
              innovation work for IRS compliance, operational efficiency, and
              potential tax benefits, through our systematic, technology-enabled
              methodology.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl max-w-4xl mx-auto italic">
              Most healthcare practices perform qualifying R&D every day without
              realizing it.
            </p>
            <p className="text-lg max-w-4xl mx-auto mt-4">
              If you&apos;re improving a process, implementing technology, or
              enhancing outcomes — you&apos;re innovating and conducting R&D.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card animate-fade-in-up">
              ...
              <p className="text-lg text-neutral-600 mb-6">
                Under IRS Section 41, R&D includes developing or improving
                business components through experimentation. In healthcare, that
                means systematic efforts to:
              </p>
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Develop new or improved <strong>clinical protocols</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Customize <strong>technology systems</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Create or enhance <strong>training programs</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Build <strong>quality improvement initiatives</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Design <strong>outcome measurement systems</strong>
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span>
                    Optimize <strong>operational workflows</strong>
                  </span>
                </li>
              </ul>
              <p className="text-lg text-neutral-600 italic">
                Innovation isn&apos;t abstract — it&apos;s the work you already
                do to serve clients better. We help you capture it, document it,
                and make it pay off.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl max-w-4xl mx-auto">
              Our systematic, technology-enabled approach transforms healthcare
              practices through documented R&D activities while improving
              operations and capturing potential tax benefits.
            </p>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {phase.activities.map((activity, actIndex) => (
                      <div
                        key={actIndex}
                        className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default"
                      >
            ...
            <div className="card bg-white border-2 border-primary-200 animate-fade-in-up">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex items-start gap-2 hover:scale-105 transition-transform duration-200">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">
                    <strong>IRS-compliant documentation packages</strong>
                  </span>
                </li>
                <li className="flex items-start gap-2 hover:scale-105 transition-transform duration-200">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">
                    <strong>Audit-ready reporting</strong>
                  </span>
                </li>
              </ul>
              <p className="text-primary-700 mb-6">
                Unlike manual competitors, our technology ensures accuracy, saves
                time, and keeps your records audit-ready 24/7.
              </p>
      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl max-w-4xl mx-auto">
              R&D consulting delivers measurable operational gains — and may
              qualify your practice for valuable tax credits.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-12">
            <div className="bg-white border-l-4 border-warning-500 p-6 rounded-lg animate-fade-in-up">
              ...
              <p className="text-warning-700">
                Tax benefits vary based on qualifying R&D activities, state
                programs, and individual circumstances. We document R&D work
                according to IRS standards. Actual benefits depend on IRS
                approval. Innovation and operational improvements are the primary
                goals—potential tax benefits are a bonus.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section" style={{ backgroundColor: "#f3f4f6" }}>
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="card bg-white border-2 border-primary-300 shadow-lg animate-slide-in-left">
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Performance-based model tied to collected revenue, not projections
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Monthly billing with quarterly reconciliation for transparency
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Payment based solely on actual results achieved
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Self-funding QRE (Qualified Research Expense) structure helps offset engagement costs
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Complete ROI Blueprint™ methodology (all three phases)
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Dedicated EA / RN / IT / BCBA research team
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    HIPAA-compliant R&D tracking and documentation platform
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Real-time R&D activity tracking and project management
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    IRS-compliant documentation packages for federal and state credits
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Quarterly strategic reviews to refine and maximize ROI
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    EA audit defense and representation
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Federal and state credit optimization for maximum benefit
                  </span>
                </div>
              </div>
            </div>
            ...
            {/* ROI Roadmap */}
            <div
              className="card bg-white border-2 border-success-300 shadow-lg animate-slide-in-right"
            ...
            >
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  ...
                  <span className="text-sm text-neutral-700">
                    Fixed-fee or performance-based options aligned with project scope
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Engagement built around measurable milestones and deliverables
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Multi-year planning framework to anticipate future credit opportunities
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Designed to complement or precede ROI Blueprint™ implementation
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Strategic R&D readiness assessment and preparation roadmap
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Comprehensive multi-year tax planning and strategy
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Business structure optimization for maximum tax and operational efficiency
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Growth roadmap to achieve long-term ROI goals
                  </span>
                </div>
                <div className="flex items-start gap-2 hover:scale-105 transition-transform duration-200 cursor-default">
                  <CheckCircle className="w-4 h-4 text-success-600 mt-1 flex-shrink-0" />
                  <span className="text-sm text-neutral-700">
                    Integration planning to ensure seamless transition to full R&D implementation
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-neutral-700 mb-4">
                Our services are structured as Qualified Research Expenditures
                (QRE) under IRS guidelines. For many clients, up to{" "}
                <strong>65% of fees</strong> may support additional tax benefits
                — potentially offsetting your investment.
              </p>
              <p className="text-lg text-neutral-700 mb-4">
                <em>
                  This means your investment in operational improvements may
                  generate its own tax benefits, separate from the R&D activities
                  we identify in your practice.
                </em>
              </p>
              <p className="text-neutral-700 mb-6">
                During your discovery call, we&apos;ll provide specific
                calculations based on your practice size and show how the
                self-funding structure applies to your situation.
              </p>
              <Link
                to="/contact"
                className="btn"
        ...
        <div className="container">
          <div className="card text-center max-w-4xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-neutral-600 mb-10 max-w-3xl mx-auto">
              Together, we&apos;ll identify where your everyday work qualifies
              for R&D value and translate those efforts into measurable financial
              gains. Start your R&D prequalification and learn where your ROI
              begins.
            </p>
