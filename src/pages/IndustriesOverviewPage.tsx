// src/pages/IndustriesOverviewPage.tsx
...
export default function IndustriesOverviewPage() {
  const industries = [
    {
      ...
      description:
        "Primary care, specialty clinics, and healthcare providers optimizing clinical protocols, integrating technology, and measuring outcomes.",
    ...
    },
    {
      ...
      description:
        "Applied Behavior Analysis, autism services, and behavioral health providers developing protocols, data systems, and training methodologies.",
  ...
  return (
    <div>
      ...
      <StructuredData
        type="webpage"
        pageTitle="Healthcare Industries We Serve | Medical & ABA Practices"
        pageDescription="ROI Blueprint serves medical practices, specialty clinics, ABA therapy providers, and behavioral health organizations. Learn how your healthcare specialty qualifies for R&D tax credits."
        pageUrl="/industries"
      />
        ...
        <div className="container">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-neutral-700 max-w-3xl mx-auto">
              We work exclusively with healthcare organizations, bringing deep clinical knowledge combined with IRS
              compliance expertise to help you research, optimize, and innovate.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {industries.map((industry, index) => (
              ...
              >
                <div
                  className={`w-20 h-20 bg-gradient-to-br ${industry.bgColor} rounded-3xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300`}
                >
          ...
          <div className="max-w-4xl mx-auto animate-fade-in-up">
            ...
            <div className="card">
              <p className="text-lg text-neutral-700 mb-6">
                Healthcare R&amp;D is fundamentally different from other industries. Clinical workflows, patient
                outcomes, regulatory compliance, and HIPAA requirements demand specialized knowledge that generalist
                consulting firms simply don’t have.
              </p>
              <p className="text-lg text-neutral-700 mb-6">
                Our team includes <strong>Registered Nurses</strong>, <strong>Board Certified Behavior Analysts</strong>,{" "}
                <strong>Enrolled Agents</strong>, and <strong>healthcare technology specialists</strong>—professionals
                who understand both the clinical realities and the IRS requirements.
              </p>
              <p className="text-lg text-neutral-700">
                This healthcare-only focus means we identify R&amp;D opportunities others miss, document work that
                withstands IRS scrutiny, and help you build systems that genuinely improve patient care while qualifying
                for tax benefits.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          <div className="card text-center max-w-4xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-neutral-600 mb-10 max-w-3xl mx-auto">
              Whether you&apos;re a medical practice or behavioral health provider, we&apos;ll help you identify,
              document, and maximize your R&amp;D opportunities. Start with a quick prequalification assessment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Link
                to="/services"
                className="btn shadow-strong transform hover:scale-110"
                style={{ backgroundColor: "white", color: "#000", border: "2px solid #89c726" }}
              >
                View Our Services
                <ArrowRight className="w-5 h-5 ml-2" />
              </Link>
