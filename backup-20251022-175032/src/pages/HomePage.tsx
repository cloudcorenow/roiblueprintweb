  ...
  return (
    <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {focusAreas.map((area, index) => (
                <div key={index} className="card group hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                  <div className="w-12 h-12 bg-primary-100 text-primary-600 rounded-xl flex items-center justify-center mb-4 group-hover:bg-primary-600 group-hover:text-white transition-all duration-300">
            ...
            {teamCredentials.map((credential, index) => (
              <div key={index} className="card group hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-center mb-2">
                  <div className="text-sm font-semibold text-primary-600 mb-1">{credential.name}</div>
                </div>
      ...
      <section className="section" style={{ backgroundColor: "#f8fafc" }}>
        <div className="container">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto mb-12">
            ...
            <div className="card border-2 border-primary-300 overflow-hidden">
              <div className="h-48 mb-6 -mx-8 -mt-8">
                <img
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-700">Practices with $1M+ annual revenue</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">At least $500K in qualified staff costs</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">US-based businesses paying US taxes</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Ready to optimize new protocols and services</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-primary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Want full R&D consulting engagement</span>
                </div>
              </div>
            ...
            <div className="card border-2 border-secondary-300 overflow-hidden">
              <div className="h-48 mb-6 -mx-8 -mt-8">
                <img
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-700">Smaller practices exploring options</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-secondary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Not ready for full R&D engagement</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-secondary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Want to understand potential first</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-secondary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Need assessment and planning</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-secondary-600 mt-1 flex-shrink-0" />
                  <span className="text-neutral-700">Exploring innovation opportunities</span>
                </div>
              </div>
          ...
          <div className="card max-w-3xl mx-auto text-center bg-gradient-to-br from-primary-50 to-primary-100 border-2 border-primary-200">
            <h3 className="text-primary-800 mb-4">Complete in Just 3 Minutes</h3>
      ...
      <section className="py-20 relative overflow-hidden" style={{
        background: 'linear-gradient(135deg, #004aad 0%, #0073e6 100%)'
      }}>
        <div className="container relative z-10">
          <div className="text-center">
            <h2 className="mb-6 text-white">Find Out If Your Healthcare Practice Qualifies for R&D Tax Credits</h2>
            ...
            <div className="max-w-2xl mx-auto mb-10">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <p className="text-white text-lg font-semibold">
                  More than <span className="text-yellow-300">80% of healthcare practices</span> we assess qualify for R&D benefits. See if yours does—it takes just <span className="text-yellow-300">3 minutes</span>.
                </p>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/contact" className="btn bg-white hover:bg-neutral-100 text-primary-600 font-semibold text-lg px-8 py-4">
