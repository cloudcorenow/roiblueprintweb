...
export default function Footer() {
  return (
    <footer className="bg-neutral-900 text-white py-12 sm:py-16 md:py-20">
      <div className="container">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-6">
            <img
              src="/ROI BlueprintV2f.png"
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li>
                <a href="mailto:innovation@roiblueprint.com" className="flex items-center gap-2 hover:text-secondary-300 transition-colors">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
