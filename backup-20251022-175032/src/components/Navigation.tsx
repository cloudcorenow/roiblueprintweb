          ...
          <div className="flex items-center justify-between h-20 lg:h-24">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden lg:flex items-center space-x-3">
                ...
                <NavLink
                  to="/contact"
                  className="bg-primary-600 hover:bg-primary-700 text-white px-5 py-2.5 rounded-xl font-semibold text-sm transition-all duration-200 shadow-md hover:shadow-lg"
                >
                  Prequalify
        ...
        <div className="lg:hidden bg-white border-b border-neutral-200 shadow-lg">
          <div className="px-6 py-6 space-y-4">
            ...
            <div className="pt-4 border-t border-neutral-200 space-y-3">
              <NavLink
                to="/contact"
                className="block bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-xl font-semibold text-center transition-all duration-200 shadow-md"
                onClick={() => setIsMenuOpen(false)}
              >
                Get Started
              </NavLink>
